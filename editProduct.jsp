...
<%@ page import="bean.ProductBean, dao.ProductDAO, dao.CategoryDAO, bean.CategoryBean, java.sql.*, java.util.*"%>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 p-0 bg-light sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link" href="customerManage.jsp">Customers</a></li>
            ...
            <div class="col-md-9 col-lg-10 p-4">
                ...
                <!-- Edit Product Form -->
                <form action="editProductAction.jsp" method="POST" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    <option value="<%= product != null ? product.getCategory() : "" %>">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3"
                                    required><%= product != null ? product.getDescription() : "" %></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="productImage" name="productImage"
                                    accept="image/*">
                                <img src="uploads/<%= product != null ? product.getProductImage() : "" %>" alt="Product Image"
